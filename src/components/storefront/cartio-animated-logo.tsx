...
export function CartioAnimatedLogo({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      <defs>
        <mask id={dotMaskId} maskUnits="userSpaceOnUse" x="0" y="0" width="173" height="173">
          <g transform="translate(-14 -14) scale(.392)">
            <circle className="cartio-header-logo__dot" cx="417" cy="274" r="58" fill="white" />
          </g>
        </mask>
        <mask id={lowerMaskId} maskUnits="userSpaceOnUse" x="0" y="0" width="173" height="173">
          <path
            className="cartio-header-logo__lower"
            pathLength="1"
        ...
        <mask id={upperMaskId} maskUnits="userSpaceOnUse" x="0" y="0" width="173" height="173">
          <path
            className="cartio-header-logo__upper"
            pathLength="1"
      ...
      <g fill="var(--color-ink)" fillRule="evenodd">
        <use href="/cartio-logo.svg#cartio-letter-c" className="cartio-header-logo__letter cartio-header-logo__letter--1" />
        <use href="/cartio-logo.svg#cartio-letter-a" className="cartio-header-logo__letter cartio-header-logo__letter--2" />
        <use href="/cartio-logo.svg#cartio-letter-r" className="cartio-header-logo__letter cartio-header-logo__letter--3" />
        <use href="/cartio-logo.svg#cartio-letter-t" className="cartio-header-logo__letter cartio-header-logo__letter--4" />
        <g className="cartio-header-logo__letter cartio-header-logo__letter--5">
          <use href="/cartio-logo.svg#cartio-letter-i-stem" />
          <use href="/cartio-logo.svg#cartio-letter-i-dot" />
        </g>
        <use href="/cartio-logo.svg#cartio-letter-o" className="cartio-header-logo__letter cartio-header-logo__letter--6" />
      </g>
    </svg>
  );
}
