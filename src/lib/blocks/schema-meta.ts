...
export const ENTITY_ORDER: string[] = ["Brand","Category","Product","ProductVariant","Warehouse","WarehouseInventory","InventoryReservation","InventoryMovement","StockTransfer","Supplier","PurchaseOrder","CommerceCustomer","Cart","Order"];
